      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        {step === 4 && bookingComplete && (
          <div className="animate-fadeIn text-center">
            ...
            <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 max-w-md mx-auto mb-6 text-white">
              <div className="flex items-center justify-center gap-3 mb-4">
                <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15h-2v-6h2v6zm4 0h-2v-6h2v6zm-2-8c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"/>
                </svg>
                <h3 className="text-xl font-bold">Betaling med MobilePay</h3>
              </div>
              <p className="text-center text-green-100 mb-4">
                Betaling sker <strong>efter</strong> vi har vasket din bil!
              </p>
              <div className="bg-white/10 rounded-xl p-4 mb-4">
                <p className="text-sm text-green-100 mb-2">Scan QR-kode eller brug mobilnummer:</p>
                <p className="text-2xl font-bold text-center">+45 60 62 70 57</p>
                <p className="text-center text-sm mt-2">Beløb: <strong>{booking.service?.price} kr.</strong></p>
              </div>
              <p className="text-xs text-center text-green-100">
                Du kan også betale kontant når vi er færdige
              </p>
            </div>
